...
export default function Document() {
  return (
    <Html lang='en' className='dark'>
      <Head>
        <meta name="title" content="Overwatch Menu Database" />
        <meta name="description" content="Overwatch Unofficial Menu/Lobby Database" />
        <meta property="og:title" content="Overwatch Menu Database" />
        <meta property="og:description" content="Overwatch Unofficial Menu/Lobby Database" />
        ...
        <meta property="twitter:title" content="Overwatch Menu Database" />
        <meta property="twitter:description" content="Overwatch Unofficial Menu/Lobby Database" />
